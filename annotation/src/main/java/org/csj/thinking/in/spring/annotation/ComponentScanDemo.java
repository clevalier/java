 ...
 */
package org.csj.thinking.in.spring.annotation;
...
@MyComponentScan2(basePackages = "org.csj.thinking.in.spring.annotation") // 指定 Class-Path(s)
//@ComponentScan(value = "org.csj.thinking.in.spring.annotation") // 指定 Class-Path(s)
